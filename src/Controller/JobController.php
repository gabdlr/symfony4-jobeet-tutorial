...
//Lista solo los resultados activos llamando la funcion findActiveJobs
//desde el repositorio JobRepository
...
//    }
    ...
    public function create(Request $request, EntityManagerInterface $em, FileUploader $fileUploader) : Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->persist($job);
            $em->flush();
            $this->addFlash('notice', 'Your job was created successfully');
